...
Clone to set up a simple agent co-researcher for your own long-horizon research. Came out of work on Erdős #872 with Claude Code + Codex. The orchestrator doesn't do the math, it handles the coordination, prompting, and commit discipline so the strong research models (Pro, DeepThink, etc.) can focus on reasoning.
